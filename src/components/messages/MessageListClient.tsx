...
export function MessageListClient({ messages, currentUserId }: MessageListClientProps) {
    ...
    return (
        <>
            <div className="space-y-4">
                {messages.map((msg) => {
                    // Quick safety check to match database records tracking buyer/seller identities
